...
The model has been inclined to writhe in the left direction, even if the potential has no have asymmetric term: this has been a consequence of the right-handed helix.
The left-handed wrapping has been statistically preferred around spherical core particle and uniform rod.
Monte Carlo simulations have suggested that two juxtaposed DNA molecules could braid each other spontaneously under moderate attractive interactions with the preference for left-handed braiding.
