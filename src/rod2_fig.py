...
def plot() :
  ...
  ax.view_init(azim=0)
  plt.savefig(f"../fig/r2_{sgm[r]}_{s}.png", bbox_inches='tight')
  plt.savefig(f"../fig/r2_{sgm[r]}_{s}.pdf", bbox_inches='tight')
  # plt.savefig(f"../fig/r2_{sgm[r]}_2000000_{s}.png", bbox_inches='tight')
  # plt.savefig(f"../fig/r2_{sgm[r]}_2000000_{s}.pdf", bbox_inches='tight')
  # plt.show()
  plt.close()
...
def plot_p() :
  ...
  # ax.legend()
  plt.savefig(f"../fig/r2_{sgm[r]}_{p}.png", bbox_inches='tight')
  plt.savefig(f"../fig/r2_{sgm[r]}_{p}.pdf", bbox_inches='tight')
  # plt.show()
  plt.close()
